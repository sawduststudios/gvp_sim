...
class HomePage extends StatelessWidget {
          ...
          children: <Widget>[
            ...
            MaterialButton(
              ...
              onPressed: () async {
                ...
                if(eventsCount != DataStorage.EVENTCOUNT) {
                  print('Filling events');
                  dumpEvents(database);
                }
                if(eventStatesCount != DataStorage.EVENTSTATECOUNT) {
                  print('Filling eventStates');
                  dumpEventStates(database);
                }
  ...
  void dumpEvents(AppDatabase db) {
    for(Event i in DataStorage.events) {
      db.insertEvent(i);
    }
  }

  void dumpEventStates(AppDatabase db) {
    for(EventState i in DataStorage.eventStates) {
      db.insertEventState(i);
    }
  }
}